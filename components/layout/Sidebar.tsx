...
import { LayoutDashboard, Store, CloudSun, Landmark, ScanLine, FlaskConical, TrendingUp, Map as MapIcon, Mic, Zap, Sparkles, Crown, Shield, ShoppingCart } from 'lucide-react';
